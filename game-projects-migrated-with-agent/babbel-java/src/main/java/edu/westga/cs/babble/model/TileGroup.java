...
/**
 * Abstract class for creating the tileGroup object
 * 
...
public abstract class TileGroup {
	 ...
	 * containment.
	 * 
	 * @return string representation of TileGroup
	 */
	public String getHand() {
		String stringTileGroup = "";
		for (Tile tile : this.tiles) {
			stringTileGroup += tile.getLetter();
		}
		return stringTileGroup;
	}
}
